...
public final class ResourceProvidersImpl implements ResourceProviders {
    ...
    public CheckEndpointNameAvailabilityOutput checkEndpointNameAvailability(
        String resourceGroupName, CheckEndpointNameAvailabilityInput checkEndpointNameAvailabilityInput) {
        CheckEndpointNameAvailabilityOutputInner inner =
            this.serviceClient().checkEndpointNameAvailability(resourceGroupName, checkEndpointNameAvailabilityInput);
        if (inner != null) {
